...
import styled from "./buttomcss/bottom.module.css";
...
let last = [
  ...
  return (
    ...
    <Box className={styled.text}><Text>In-store pricing may vary. Prices and offers are subject to change. © 2022 Best Buy. All rights reserved. BEST BUY, the BEST BUY logo, the tag design, and MY BEST BUY are trademarks of Best Buy and its affiliated companies.</Text></Box>
    </>
  );
}
